  ...
  return (
    <div className="w-full min-h-screen bg-primary-100 flex items-center justify-center">
      <div className="text-center relative">
        <h1
          className="text-4xl md:text-6xl lg:text-7xl text-primary-900 font-bold mb-4"
          id="name"
        ...
        {showTips && (
          <p
            ...
            id="name_tips"
          >
            (et pas Dubreuil, c'est important <br /> on se trompe souvent)
          </p>
        )}
        <h2 className="text-2xl md:text-4xl text-accent-500 font-semibold mb-6">
          Développeur Web
        </h2>
        <p className="text-lg md:text-xl text-primary-900 mb-8">
